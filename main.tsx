      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-3xl p-6 space-y-5">
        ...
        <div className="space-y-4 pt-2">
          {MOOD_DIMENSIONS.map((dim) => {
            ...
            return (
              <div key={dim.key} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-950/25 p-4 border border-slate-850/60 rounded-2xl">
                <span className="text-xs font-semibold text-slate-300 sm:w-28 shrink-0">{dim.label}</span>
